...
class AIStrategy(IStrategy):
    ...
    buy_params = {'buy_ma_count': 17, 'buy_ma_gap': 39}
    sell_params = {'sell_ma_count': 15, 'sell_ma_gap': 75}
    ...
    count_max = 20
    gap_max = 100
    buy_ma_count = IntParameter(1, count_max, default=17, space='buy')
    buy_ma_gap = IntParameter(1, gap_max, default=39, space='buy')
    sell_ma_count = IntParameter(1, count_max, default=15, space='sell')
    sell_ma_gap = IntParameter(1, gap_max, default=75, space='sell')
