...
class AIStrategy(IStrategy):
    ...
    buy_ma_gap = IntParameter(1, gap_max, default=48, space='buy')
    sell_ma_count = IntParameter(1, count_max, default=9, space='sell')
    sell_ma_gap = IntParameter(1, gap_max, default=62, space='sell')
